...
- Name: productdetails.spec.js >> product details service >> erify Product Price is Displayed correctly in the homepage and the details page
- Location: tests/productdetails.spec.js:23:9
...
Call log:
  ...
  - waiting for locator('//*[@id="tbodyid"]/h3')
