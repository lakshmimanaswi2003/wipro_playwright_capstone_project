...
- Name: productdetails.spec.js >> product details service >> verifying the internalstorage details are same or not in both homepage and details page
- Location: tests/productdetails.spec.js:53:9
