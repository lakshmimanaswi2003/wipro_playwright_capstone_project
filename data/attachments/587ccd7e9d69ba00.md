...
- Name: productdetails.spec.js >> product details service >> verify weather the monitor description is visible or not
- Location: tests/productdetails.spec.js:119:9
...
Locator: getByText('LED Cinema Display features')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('LED Cinema Display features')
