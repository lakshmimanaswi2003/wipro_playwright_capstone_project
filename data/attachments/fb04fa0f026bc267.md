...
- Name: productdetails.spec.js >> product details service >> verifying the core details are same or not in both home page and details page
- Location: tests/productdetails.spec.js:35:9
