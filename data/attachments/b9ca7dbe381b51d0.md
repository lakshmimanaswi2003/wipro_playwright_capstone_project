...
- Name: productdetails.spec.js >> product details service >> verify weather the product is add to the cart or not
- Location: tests/productdetails.spec.js:77:9
...
Locator: locator('#tbodyid tr td:nth-child(2)')
...
Call log:
  ...
  - waiting for locator('#tbodyid tr td:nth-child(2)')
